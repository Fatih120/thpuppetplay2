...
const u8 gText_ExpandedPlaceholder_CMiko[] = _("CMIKO");
const u8 gText_ExpandedPlaceholder_Miko[] = _("MIKO");
const u8 gText_ExpandedPlaceholder_Brendan[] = _("BRENDAN");
const u8 gText_ExpandedPlaceholder_May[] = _("MAY");
const u8 gText_EggNickname[] = _("EGG");
const u8 gText_Pokemon[] = _("Puppet");
const u8 gText_ProfBirchMatchCallName[] = _("PROF. BIRCH");
const u8 gText_MainMenuNewGame[] = _("New Story");
const u8 gText_MainMenuContinue[] = _("Resume Adventure");
const u8 gText_MainMenuOption[] = _("Settings");
...
const u8 gText_BirchBoy[] = _("Coffee");
const u8 gText_BirchGirl[] = _("Tea");
const u8 gText_DefaultNameStu[] = _("Renko");
const u8 gText_DefaultNameMilton[] = _("Usami");
...
const u8 gText_DefaultNameTiara[] = _("Maribel");
const u8 gText_DefaultNameBella[] = _("Hearn");
...
const u8 gText_PokedexRegistration[] = _("Puppet record completed.");
...
const u8 gText_SwitchPokedexListings[] = _("Switch puppet listings.");
...
const u8 gText_HOFDexRating[] = _("Spotted puppets: {STR_VAR_1}!\nOwned puppets: {STR_VAR_2}!\pPROF. BIRCH's POKéDEX rating!\pPROF. BIRCH: Let's see…\p");
const u8 gText_HOFDexSaving[] = _("Girls are now saving.\nPlease don't turn off the power.");
...
const u8 gText_FlyToWhere[] = _("Where would you like to fly?");
...
const u8 gText_BoxFull[] = _("The Gap is full.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PokeBallsPocket[] = _("Sealing Orbs");
const u8 gText_TMHMPocket[] = _("Blessings");
...
const u8 gText_ThrowInPremierBall[] = _("I'll throw in a Celebratory Seal, too.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TeachWhichPokemon2[] = _("Teach which puppet?"); // Unused
...
const u8 gText_PokemonAreNeeded[] = _("{STR_VAR_1} puppet are needed.");
const u8 gText_PokemonCantBeSame[] = _("puppet can't be the same.");
...
const u8 gText_HEirinDollAndPrice[] = _("HEIRIN DOLL 1,000 COINS");
const u8 gText_AAliceDollAndPrice[] = _("AALICE DOLL 1,000 COINS");
const u8 gText_DReimuDollAndPrice[] = _("DREIMU DOLL   1,000 COINS");
...
const u8 gText_MenuOptionPokemon[] = _("Puppet");
...
const u8 gText_MenuOptionOption[] = _("Settings");
const u8 gText_MenuOptionExit[] = _("Close");
...
const u8 gText_PokemonJump[] = _("puppet JUMP");
const u8 gText_DaiyouseiBerryPicking[] = _("DAIYOUSEI BERRY-PICKING");
...
const u8 gText_ReleaseThisPokemon[] = _("Release this puppet?");
const u8 gText_PkmnWasReleased[] = _("{SPECIAL_F7 0x00} was released.");
const u8 gText_ByeByePkmn[] = _("Sayonara, {SPECIAL_F7 0x00}!");
const u8 gText_MarkYourPkmn[] = _("Mark your puppet.");
const u8 gText_ThatsYourLastPkmn[] = _("That's your last puppet!");
const u8 gText_YourPartysFull[] = _("Your party's full!");
const u8 gText_YoureHoldingAPkmn[] = _("You're holding a puppet!");
...
const u8 gText_GiveToAPkmn[] = _("GIVE to a puppet?");
...
const u8 gText_WithdrawPokemon[] = _("Withdraw Puppets");
const u8 gText_DepositPokemon[] = _("Deposit Puppets");
const u8 gText_MovePokemon[] = _("Move Puppets");
const u8 gText_MoveItems[] = _("Move Items");
const u8 gText_SeeYa[] = _("Nothing");
const u8 gText_WithdrawMonDescription[] = _("Move puppets stored in BOXES to\nyour party.");
const u8 gText_DepositMonDescription[] = _("Store puppets in your party in BOXES.");
const u8 gText_MoveMonDescription[] = _("Organize the puppets in BOXES and\nin your party.");
const u8 gText_MoveItemsDescription[] = _("Move items held by any puppets\nin a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("Return to the previous menu.");
const u8 gText_JustOnePkmn[] = _("There is just one puppet with you.");
...
const u8 gText_CheckPokemonInDetail[] = _("Check puppets in detail.");
...
const u8 gText_CheckPartyPokemonInDetail[] = _("Check party puppets in detail.");
const u8 gText_CheckAllPokemonInDetail[] = _("Check all puppets in detail.");
const u8 gText_ReturnToPokenavMenu[] = _("Return to the POKéNAV menu.");
const u8 gText_FindCoolPokemon[] = _("Find cool puppets.");
const u8 gText_FindBeautifulPokemon[] = _("Find beautiful puppets.");
const u8 gText_FindCutePokemon[] = _("Find cute puppets.");
const u8 gText_FindSmartPokemon[] = _("Find smart puppets.");
const u8 gText_FindToughPokemon[] = _("Find tough puppets.");
...
const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("TRAINER'S Puppets");
...
const u8 gText_StopGivingPkmnMail2[] = _("Stop giving the puppet MAIL?"); // Unused
...
const u8 gText_DKanakoDoll32BP[] = _("DKANAKO DOLL{CLEAR_TO 0x5E}32BP");
const u8 gText_MargatroidDoll48BP[] = _("MARGATROID DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_CChenDoll48BP[] = _("CCHEN DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_CYukariDoll48BP[] = _("CYUKARI DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_KedamaDoll48BP[] = _("KEDAMA DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_CEllyDoll80BP[] = _("CELLY DOLL{CLEAR_TO 0x5E}80BP");
const u8 gText_GenjiDoll80BP[] = _("GENJI DOLL{CLEAR_TO 0x5E}80BP");
const u8 gText_OrangeDoll80BP[] = _("ORANGE DOLL{CLEAR_TO 0x5E}80BP");
const u8 gText_TewiDoll128BP[] = _("TEWI DOLL{CLEAR_TO 0x58}128BP");
const u8 gText_ByakurenDoll128BP[] = _("BYAKUREN DOLL{CLEAR_TO 0x58}128BP");
const u8 gText_CAliceDoll256BP[] = _("CALICE DOLL{CLEAR_TO 0x58}256BP");
const u8 gText_ReisenDoll256BP[] = _("REISEN DOLL{CLEAR_TO 0x58}256BP");
const u8 gText_CLilyBlackDoll256BP[] = _("CLILYBLACK DOLL{CLEAR_TO 0x58}256BP");
...
const u8 gText_Pokemon2[] = _("Puppet");
...
const u8 gText_BerryPickingRecords[] = _("DAIYOUSEI BERRY-PICKING RECORDS");
...
const u8 gText_PokemonOnHook[] = _("A puppet's on the hook!{PAUSE_UNTIL_PRESS}");
...
const u8 gEasyChatGroupName_Pokemon[] = _("PUPPET");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("PUPPET2");
