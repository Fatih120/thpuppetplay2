...
const u8 gText_ListBySourceGame[] = _("List by source material.\nSpotted POKéMON only.");
...
const u8 gText_GenjiiDoll80BP[] = _("GENJII DOLL{CLEAR_TO 0x5E}80BP");
