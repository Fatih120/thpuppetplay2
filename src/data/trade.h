...
static const u8 sText_AShouJP[] = _("ヌケニン");
...
static const struct InGameTrade sIngameTrades[] =
{
    [INGAME_TRADE_SRIN] =
    {
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_TENMA
    },
    [INGAME_TRADE_TNAZRIN] =
    {
        .nickname = _("PLUSES"),
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_YUKI
    },
    [INGAME_TRADE_CLUNACHILD] =
    {
        .nickname = _("SEASOR"),
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_KYOUKO
    },
    [INGAME_TRADE_CCHEN] =
    {
        .nickname = _("MEOWOW"),
        ...
        .otGender = FEMALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_ASUNNYMILK
    }
};
...
{
    {
        ...
        EC_WORD_PLEASE,
        EC_WORD_TRAIN,
        EC_POKEMON(CLUNACHILD),
        EC_WORD_WELL
    }, {
        EC_WORD_THANK_YOU,
        EC_WORD_FOR,
        EC_POKEMON(ASUNNYMILK),
        EC_POKEMON_NATIONAL(CCHEN),
        EC_WORD_CRIES,
        EC_WORD_IN,
        EC_WORD_A,
        EC_WORD_CUTE,
