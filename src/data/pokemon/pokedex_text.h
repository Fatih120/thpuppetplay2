...
const u8 gLilyWhitePokedexText[] = _(
...
const u8 gLilyBlackPokedexText[] = _(
...
const u8 gCShizuhaPokedexText[] = _(
...
const u8 gShizuhaPokedexText[] = _(
...
const u8 gCMedicinePokedexText[] = _(
    "A CMEDICINE is extremely territorial.\n"
    "For safety reasons, no one should \n"
    "ever approach its nest. If angered,\n"
    "they will attack in a swarm.");

const u8 gMedicinePokedexText[] = _(
...
const u8 gCKoakumaPokedexText[] = _(
...
const u8 gRemiliaPokedexText[] = _(
...
const u8 gShanghaiPokedexText[] = _(
...
const u8 gCFlandrePokedexText[] = _(
...
const u8 gFlandrePokedexText[] = _(
...
const u8 gCChenPokedexText[] = _(
    "CCHEN withdraw their sharp claws into\n"
    "their paws to silently sneak about.\n"
    "For some reason, this POKéMON loves\n"
    "shiny coins that glitter with light.");

const u8 gChenPokedexText[] = _(
    "A CHEN's six bold whiskers sense air\n"
    "movements to determine what is in its\n"
    "vicinity. It becomes docile if grabbed\n"
    "by the whiskers.");

const u8 gCYorihimePokedexText[] = _(
...
const u8 gCHatatePokedexText[] = _(
...
const u8 gYuugiPokedexText[] = _(
    "A belt is worn by a YUUGI to keep its\n"
    "overwhelming power under control.\n"
    "Because it is so dangerous, no one has\n"
    "ever removed the belt.");

const u8 gCTenshiPokedexText[] = _(
...
const u8 gCMurasaPokedexText[] = _(
...
const u8 gCKisumePokedexText[] = _(
...
const u8 gCKogasaPokedexText[] = _(
...
const u8 gCDaiyouseiPokedexText[] = _(
...
const u8 gCHinaPokedexText[] = _(
    "Born from polluted sludge in the sea,\n"
    "CHINA's favorite food is anything filthy.\n"
    "They feed on wastewater pumped out from\n"
    "factories.");

const u8 gHinaPokedexText[] = _(
    "It prefers warm and humid habitats.\n"
    "In the summertime, the toxic substances\n"
    "in its body intensify, making HINA reek like\n"
    "putrid kitchen garbage.");

const u8 gCKomachiPokedexText[] = _(
...
const u8 gCMerlinPokedexText[] = _(
...
const u8 gCLyricaPokedexText[] = _(
...
const u8 gLyricaPokedexText[] = _(
    "Originally from the tropics, LYRICA's\n"
    "heads grow larger from exposure to strong\n"
    "sunlight. It is said that when the heads\n"
    "fall, they group to form an CLYRICA.");
...
const u8 gLunaChildPokedexText[] = _(
...
const u8 gCStarSapphirePokedexText[] = _(
    "In the springtime, schools of CSTARSAPPHIRE\n"
    "can be seen swimming up falls and rivers.\n"
    "It metes out staggering damage with its\n"
    "single horn.");

const u8 gStarSapphirePokedexText[] = _(
...
const u8 gCShikieikiPokedexText[] = _(
    "A CSHIKIEIKI sashays rhythmically as if it were\n"
    "dancing. Its motions are so bouncingly\n"
    "alluring, people seeing it are compelled to\n"
    "shake their hips without noticing.");

const u8 gShikieikiPokedexText[] = _(
    ...
    "SHIKIEIKI in place of lightning rods.");

const u8 gCShouPokedexText[] = _(
...
const u8 gSuwakoPokedexText[] = _(
    "SUWAKO's fluffy fur releases heat into\n"
...
const u8 gAkyuuPokedexText[] = _(
    "A AKYUU is said to possess the genes of all\n"
...
const u8 gCOrangePokedexText[] = _(
    "It can hide behind a shimmering heat haze\n"
    "that it creates using its intense flames.\n"
    "CORANGE create blazing explosive\n"
    "blasts that burn everything to cinders.");

const u8 gOrangePokedexText[] = _(
    "Despite its small body, ORANGE's jaws\n"
...
const u8 gCChiyuriPokedexText[] = _(
...
const u8 gChiyuriPokedexText[] = _(
...
const u8 gCHakureiPokedexText[] = _(
    ...
    "have long believed that CHAKUREI are\n"
    "emissaries from another world.");

const u8 gHakureiPokedexText[] = _(
...
const u8 gCKirisamePokedexText[] = _(
...
const u8 gKirisamePokedexText[] = _(
...
const u8 gCKotohimePokedexText[] = _(
...
const u8 gKotohimePokedexText[] = _(
...
const u8 gHStarSapphirePokedexText[] = _(
...
const u8 gANitoriPokedexText[] = _(
...
const u8 gTNitoriPokedexText[] = _(
    "TNITORI live even further underground\n"
    "than MEILING. This POKéMON is known to dig\n"
    "toward the earth's core, reaching a depth\n"
    "of over six-tenths of a mile underground.");

const u8 gAMokouPokedexText[] = _(
    "By baring its fangs and making a scary\n"
    "face, it sends smaller POKéMON scurrying\n"
    "in terror. The AMOKOU does seem a\n"
    "little sad at making its foes flee.");

const u8 gDMokouPokedexText[] = _(
...
const u8 gAKaguyaPokedexText[] = _(
    "If it touches metal and discharges the\n"
    "electricity it has stored in its body, an\n"
    "AKAGUYA begins swinging its arms in circles\n"
    "to recharge itself.");

const u8 gDKaguyaPokedexText[] = _(
    "If a DKAGUYA is spouting yellow flames from\n"
    "its mouth, it is in good health. When it is\n"
    "fatigued, black smoke will be mixed in with\n"
    "the flames.");

const u8 gShinGyokuOPokedexText[] = _(
...
const u8 gDYukariPokedexText[] = _(
    "Leaves grow out of this POKéMON's body.\n"
    "They help obscure a DYUKARI from the eyes\n"
    "of its enemies while it is in a thickly\n"
    "overgrown forest.");

const u8 gTYukariPokedexText[] = _(
...
const u8 gDYuyukoPokedexText[] = _(
...
const u8 gAYuyukoPokedexText[] = _(
    "In the wild, AYUYUKO live in a pack.\n"
    "They never defy their leader's orders.\n"
    "They defeat foes with perfectly\n"
    "coordinated teamwork.");

const u8 gHLunasaPokedexText[] = _(
...
const u8 gHMerlinPokedexText[] = _(
...
const u8 gHLyricaPokedexText[] = _(
...
const u8 gARanPokedexText[] = _(
    "It prepares for evolution using the\n"
    "energy it stored while it was a HLYRICA.\n"
    "It keeps watch over the surroundings with\n"
    "its two eyes.");

const u8 gHRanPokedexText[] = _(
...
const u8 gAMedicinePokedexText[] = _(
...
const u8 gTMedicinePokedexText[] = _(
...
const u8 gSShizuhaPokedexText[] = _(
...
const u8 gTenmaPokedexText[] = _(
    "A TENMA has the power to sense the\n"
...
const u8 gDWrigglePokedexText[] = _(
...
const u8 gALilyWhitePokedexText[] = _(
...
const u8 gCMimaPokedexText[] = _(
    "Hordes of CMIMA gather around trees\n"
    "when fruits come into season. They wait\n"
    "around patiently for ripened fruits to fall\n"
    "out of the trees.");

const u8 gHShizuhaPokedexText[] = _(
...
const u8 gASuwakoPokedexText[] = _(
...
const u8 gTToyohimePokedexText[] = _(
    "Because lightning falls in their vicinities,\n"
    "TTOYOHIME were thought to have been born\n"
    "from lightning. In battle, they create\n"
    "thunderclouds.");

const u8 gTNazrinPokedexText[] = _(
...
const u8 gHNazrinPokedexText[] = _(
    "At a meeting of POKéMON academics, it was\n"
    "announced that simultaneous exposure to\n"
    "electricity from a TNAZRIN and HNAZRIN will\n"
    "promote circulation and boost vitality.");

const u8 gYukiPokedexText[] = _(
    "With their taillights lit, YUKI fly in\n"
...
const u8 gCKikuriPokedexText[] = _(
...
const u8 gDMeilingPokedexText[] = _(
...
const u8 gTensokuPokedexText[] = _(
    "It breathes through nostrils that it\n"
    "raises above the sea. By inhaling to its\n"
    "maximum capacity, a TENSOKU can dive close\n"
    "to 10,000 feet beneath the waves.");

const u8 gCKonngaraPokedexText[] = _(
    "A CKONNGARA stores boiling magma in the hump\n"
...
const u8 gCSarielPokedexText[] = _(
...
const u8 gALilyBlackPokedexText[] = _(
...
const u8 gSKogasaPokedexText[] = _(
...
const u8 gDMinorikoPokedexText[] = _(
...
const u8 gRinnosukePokedexText[] = _(
...
const u8 gAPatchouliPokedexText[] = _(
...
const u8 gCWakasagiPokedexText[] = _(
...
const u8 gSMedicinePokedexText[] = _(
...
const u8 gAMinorikoPokedexText[] = _(
    "A AMINORIKO loves to eat sweet fruits.\n"
    "It cleverly picks fruits using its earlike\n"
    "arms. They gather in fruit gardens, drawn\n"
    "by the fragrance.");

const u8 gDPatchouliPokedexText[] = _(
    "They tend to move about in groups of\n"
    "around five DPATCHOULI. In snowy regions,\n"
    "it is said that when they are seen late at\n"
    "night, snowfall will arrive by morning.");

const u8 gDLettyPokedexText[] = _(
    "A DLETTY has the power to instantaneously\n"
...
const u8 gAKazamiPokedexText[] = _(
    "A AKAZAMI siphons the body fluids of prey\n"
...
const u8 gCSeigaPokedexText[] = _(
    "When CSEIGA gather in a swarm, they move\n"
    "in perfect unison as if they were but one\n"
    "POKéMON. They communicate with each other\n"
    "using brain waves.");

const u8 gSeigaPokedexText[] = _(
...
const u8 gMamizouPokedexText[] = _(
...
const u8 gCMikoPokedexText[] = _(
    "CMIKO has appeared in mythology as the\n"
    "creator of the sea. After long years of\n"
    "feuding with MIKO, it took to sleep at\n"
    "the bottom of the sea.");

const u8 gMikoPokedexText[] = _(
    "MIKO has appeared in mythology as the\n"
    "creator of the land. It sleeps in magma\n"
    "underground and is said to make volcanoes\n"
    "erupt on awakening.");

const u8 gCMamizouPokedexText[] = _(
    "A POKéMON that flies endlessly in the\n"
    "ozone layer. It is said it would descend\n"
    "to the ground if CMIKO and MIKO\n"
    "were to fight.");

const u8 gKasenPokedexText[] = _(
    "KASEN is said to make wishes come true.\n"
    "While it sleeps, a tough crystalline shell\n"
    "envelops the body to protect it from\n"
    "enemies.");

const u8 gGomasekiPokedexText[] = _(
