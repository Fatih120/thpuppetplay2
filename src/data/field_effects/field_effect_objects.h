...
static const union AnimCmd *const gFieldEffectObjectImageAnimTable_CMamizou[] = {
    sAnim_Rayquaza,
};
...
const struct SpriteTemplate gFieldEffectObjectTemplate_CMamizou = {
    .tileTag = 0xFFFF,
    .paletteTag = 0xFFFF,
    .oam = &gObjectEventBaseOam_32x32,
    .anims = gFieldEffectObjectImageAnimTable_CMamizou,
    .images = gFieldEffectObjectPicTable_CMamizou,
    .affineAnims = gDummySpriteAffineAnimTable,
