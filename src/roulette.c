...
static u8 GetRandomForBallTravelDistance(u16 ballNum, u16 rand)
{
    ...
    {
    case HAS_SHROOMISH: // DSUWAKO
    case HAS_TAILLOW: // TSHOU
...
static const u16 sShroomish_Pal[] = INCBIN_U16("graphics/roulette/dsuwako.gbapal");
...
static const u16 sWynaut_Pal[] = INCBIN_U16("graphics/roulette/aminoriko.gbapal");
static const u16 sAzurill_Pal[] = INCBIN_U16("graphics/roulette/cshingyoku.gbapal");
static const u16 sSkitty_Pal[] = INCBIN_U16("graphics/roulette/asunnymilk.gbapal");;
static const u16 sMakuhita_Pal[] = INCBIN_U16("graphics/roulette/aflandre.gbapal");
