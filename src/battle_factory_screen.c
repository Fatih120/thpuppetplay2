...
static void Swap_ShowSummaryMonSprite(void)
{
    ...
    sFactorySwapScreen->unk2C.field0 = CreateMonPicSprite_HandleGomaseki(species, personality, otId, TRUE, 88, 32, 15, 0xFFFF); // BUG: otId and personality should be switched.
