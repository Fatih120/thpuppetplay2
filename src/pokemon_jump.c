...
{
    { .species = SPECIES_CSANAE,  .unk2 = 2, },
    { .species = SPECIES_ALICE, .unk2 = 1, },
    { .species = SPECIES_CLILYWHITE,   .unk2 = 0, },
    { .species = SPECIES_LILYBLACK,   .unk2 = 1, },
    { .species = SPECIES_CMOMIJI,    .unk2 = 1, },
    { .species = SPECIES_CSHIZUHA,     .unk2 = 1, },
    { .species = SPECIES_SHIZUHA,     .unk2 = 1, },
    { .species = SPECIES_CNAZRIN,    .unk2 = 1, },
    { .species = SPECIES_NAZRIN,   .unk2 = 1, },
    { .species = SPECIES_CCIRNO,    .unk2 = 0, },
    { .species = SPECIES_CRUMIA,  .unk2 = 0, },
    { .species = SPECIES_SHANGHAI,  .unk2 = 0, },
    { .species = SPECIES_HOURAI,  .unk2 = 0, },
    { .species = SPECIES_CYUKARI,   .unk2 = 0, },
    { .species = SPECIES_CSUIKA,     .unk2 = 0, },
    { .species = SPECIES_CMYSTIA, .unk2 = 2, },
    { .species = SPECIES_CKEINE,     .unk2 = 2, },
    { .species = SPECIES_CIKU,      .unk2 = 1, },
    { .species = SPECIES_CCHEN,     .unk2 = 0, },
    { .species = SPECIES_CYORIHIME,    .unk2 = 2, },
    { .species = SPECIES_CKAGUYA,     .unk2 = 1, },
    { .species = SPECIES_CMOKOU,  .unk2 = 1, },
    { .species = SPECIES_CHATATE,    .unk2 = 2, },
    { .species = SPECIES_TENSHI, .unk2 = 2, },
    { .species = SPECIES_CKOMACHI,   .unk2 = 1, },
    { .species = SPECIES_CLUNASA,     .unk2 = 1, },
    { .species = SPECIES_CLYRICA,  .unk2 = 2, },
    { .species = SPECIES_CLAYLA,     .unk2 = 0, },
    { .species = SPECIES_KEDAMA,      .unk2 = 2, },
    { .species = SPECIES_CNUE,      .unk2 = 0, },
    { .species = SPECIES_CMARISA,    .unk2 = 1, },
    { .species = SPECIES_CREIMU,     .unk2 = 1, },
    { .species = SPECIES_GENJI,  .unk2 = 2, },
    { .species = SPECIES_CELLY,  .unk2 = 1, },
    { .species = SPECIES_ORANGE,   .unk2 = 0, },
    { .species = SPECIES_KAZAMI,   .unk2 = 1, },
    { .species = SPECIES_CLUIZE,      .unk2 = 0, },
    { .species = SPECIES_LUIZE,     .unk2 = 0, },
    { .species = SPECIES_CMARGATROID,  .unk2 = 2, },
    { .species = SPECIES_MARGATROID,     .unk2 = 2, },
    { .species = SPECIES_HAKUREI,     .unk2 = 0, },
    { .species = SPECIES_CKOTOHIME,  .unk2 = 2, },
    { .species = SPECIES_KOTOHIME,     .unk2 = 2, },
    { .species = SPECIES_RIKA,    .unk2 = 2, },
    { .species = SPECIES_CGENGETSU,     .unk2 = 2, },
    { .species = SPECIES_DSUNNYMILK,     .unk2 = 2, },
    { .species = SPECIES_AMOKOU,   .unk2 = 0, },
    { .species = SPECIES_TSAKUYA,    .unk2 = 2, },
    { .species = SPECIES_SRUMIA,  .unk2 = 0, },
    { .species = SPECIES_AMYSTIA,     .unk2 = 2, },
    { .species = SPECIES_TCHEN,     .unk2 = 0, },
    { .species = SPECIES_DTENSHI,   .unk2 = 1, },
    { .species = SPECIES_AKOISHI,     .unk2 = 0, },
    { .species = SPECIES_DBYAKUREN,   .unk2 = 0, },
    { .species = SPECIES_TICHIRIN,    .unk2 = 1, },
    { .species = SPECIES_DKANAKO,   .unk2 = 2, },
    { .species = SPECIES_AKAGUYA,     .unk2 = 1, },
    { .species = SPECIES_DKAGUYA,      .unk2 = 1, },
    { .species = SPECIES_DMOMIJI,   .unk2 = 1, },
    { .species = SPECIES_HEIRIN,    .unk2 = 1, },
    { .species = SPECIES_AALICE,    .unk2 = 2, },
    { .species = SPECIES_DREIMU,     .unk2 = 0, },
    { .species = SPECIES_SCIRNO,  .unk2 = 0, },
    { .species = SPECIES_DYUYUKO,  .unk2 = 1, },
    { .species = SPECIES_HLUNASA,  .unk2 = 0, },
    { .species = SPECIES_HMERLIN,    .unk2 = 0, },
    { .species = SPECIES_HLYRICA,    .unk2 = 1, },
    { .species = SPECIES_ARAN,    .unk2 = 2, },
    { .species = SPECIES_AMEDICINE,    .unk2 = 2, },
    { .species = SPECIES_AHINA,      .unk2 = 2, },
    { .species = SPECIES_SRIN,     .unk2 = 1, },
    { .species = SPECIES_TENMA,      .unk2 = 0, },
    { .species = SPECIES_SENDAI,     .unk2 = 0, },
    { .species = SPECIES_SFLANDRE,    .unk2 = 2, },
    { .species = SPECIES_DSUWAKO,  .unk2 = 2, },
    { .species = SPECIES_HSHIZUHA,    .unk2 = 1, },
    { .species = SPECIES_SMARISA,    .unk2 = 0, },
    { .species = SPECIES_CSHINGYOKU,    .unk2 = 2, },
    { .species = SPECIES_ASUNNYMILK,     .unk2 = 0, },
    { .species = SPECIES_ADVMYSTIA,    .unk2 = 0, },
    { .species = SPECIES_TKISUME,     .unk2 = 0, },
    { .species = SPECIES_ADVTEWI,       .unk2 = 1, },
    { .species = SPECIES_AYUUGI,   .unk2 = 2, },
    { .species = SPECIES_ASHIKIEIKI,  .unk2 = 1, },
    { .species = SPECIES_TNAZRIN,     .unk2 = 1, },
    { .species = SPECIES_HNAZRIN,      .unk2 = 1, },
    { .species = SPECIES_YUKI,    .unk2 = 0, },
    { .species = SPECIES_ADVMOKOU,   .unk2 = 0, },
    { .species = SPECIES_ADVREISEN,    .unk2 = 2, },
    { .species = SPECIES_CKIKURI,     .unk2 = 2, },
    { .species = SPECIES_CKONNGARA,      .unk2 = 2, },
    { .species = SPECIES_CSARIEL,    .unk2 = 2, },
    { .species = SPECIES_ALILYBLACK,     .unk2 = 0, },
    { .species = SPECIES_DMINORIKO,   .unk2 = 2, },
    { .species = SPECIES_ANUE,     .unk2 = 2, },
    { .species = SPECIES_ADVCHEN,    .unk2 = 1, },
    { .species = SPECIES_AMINORIKO,     .unk2 = 0, },
    { .species = SPECIES_DPATCHOULI,    .unk2 = 0, },
    { .species = SPECIES_AMURASA,   .unk2 = 1, },
    { .species = SPECIES_KYOUKO,      .unk2 = 1, },
};
...
static const u16 gPkmnJumpCAlicePal[] = INCBIN_U16("graphics/link_games/pkmnjump_calice.gbapal");
static const u32 gPkmnJumpCAliceGfx[] = INCBIN_U32("graphics/link_games/pkmnjump_calice.4bpp.lz");
static const u32 gPkmnJumpCAliceTilemap[] = INCBIN_U32("graphics/link_games/pkmnjump_calice.bin.lz");
...
static void sub_802D150(void)
{
    ...
    case 0:
        ...
        LoadPalette(gPkmnJumpCAlicePal, 0x30, 0x20);
        DecompressAndCopyTileDataToVram(2, gPkmnJumpCAliceGfx, 0, 0, 0);
        DecompressAndCopyTileDataToVram(2, gPkmnJumpCAliceTilemap, 0, 0, 1);
