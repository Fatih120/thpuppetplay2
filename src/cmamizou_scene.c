...
{
    gRaySceneMiko_Gfx, 0x3000, TAG_DUOFIGHT_GROUDON
};

static const struct CompressedSpritePalette sSpritePal_DuoFight_Groudon =
{
    gRaySceneMiko_Pal, TAG_DUOFIGHT_GROUDON
};
...
{
    gRaySceneMiko2_Gfx, 0x200, TAG_DUOFIGHT_GROUDON_SHOULDER
};
...
{
    gRaySceneMiko3_Gfx, 0x400, TAG_DUOFIGHT_GROUDON_CLAW
};
...
{
    gRaySceneCMiko_Gfx, 0xF00, TAG_DUOFIGHT_KYOGRE
};

static const struct CompressedSpritePalette sSpritePal_DuoFight_Kyogre =
{
    gRaySceneCMiko_Pal, TAG_DUOFIGHT_KYOGRE
};
...
{
    gRaySceneCMiko2_Gfx, 0xC0, TAG_DUOFIGHT_KYOGRE_PECTORAL_FIN
};
...
{
    gRaySceneCMiko3_Gfx, 0x200, TAG_DUOFIGHT_KYOGRE_DORSAL_FIN
};
...
{
    gRaySceneCMamizouFly1_Gfx, 0x1000, TAG_DESCENDS_RAYQUAZA
};

static const struct CompressedSpriteSheet sSpriteSheet_Descends_RayquazaTail =
{
    gRaySceneCMamizouTail_Gfx, 0x200, TAG_DESCENDS_RAYQUAZA_TAIL
};

static const struct CompressedSpritePalette sSpritePal_Descends_Rayquaza =
{
    gRaySceneCMamizou_Pal, TAG_DESCENDS_RAYQUAZA // "Takes flight" palette re-used here
};
...
static void LoadTakesFlightSceneGfx(void)
{
    ...
    DecompressAndCopyTileDataToVram(2, gRaySceneCMamizou_Gfx, 0, 0, 0);
    while (FreeTempTileDataBuffersIfPossible());
...
{
    ResetTempTileDataBuffers();
    DecompressAndCopyTileDataToVram(0, gRaySceneCMamizouLight_Gfx, 0, 0, 0);
...
{
    ResetTempTileDataBuffers();
    DecompressAndCopyTileDataToVram(1, gRaySceneCMamizouChase_Gfx, 0, 0, 0);
