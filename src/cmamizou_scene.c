...
{
    gRaySceneMiko_Gfx, 0x3000, GFXTAG_GROUDON
};

static const struct CompressedSpritePalette sUnknown_0862A8CC =
{
    gRaySceneMiko_Pal, PALTAG_GROUDON
};
...
{
    gRaySceneMiko2_Gfx, 0x200, GFXTAG_GROUDON_SHOULDER
};
...
{
    gRaySceneMiko3_Gfx, 0x400, GFXTAG_GROUDON_CLAW
};
...
{
    gRaySceneCMiko_Gfx, 0xF00, GFXTAG_KYOGRE1
};

static const struct CompressedSpritePalette sUnknown_0862A9DC =
{
    gRaySceneCMiko_Pal, PALTAG_KYOGRE
};
...
{
    gRaySceneCMiko2_Gfx, 0xC0, GFXTAG_KYOGRE2
};
...
{
    gRaySceneCMiko3_Gfx, 0x200, GFXTAG_KYOGRE3
};
...
{
    gRaySceneMikoLeft_Gfx, 0x1800, GFXTAG_GROUDON_SIDE
};
...
{
    gRaySceneMikoLeft_Pal, GFXTAG_GROUDON_SIDE
};
