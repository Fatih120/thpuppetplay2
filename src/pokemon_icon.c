...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_REYSEN] = gMonIcon_Reysen,
    ...
    [SPECIES_ADVMYSTIA] = gMonIcon_AdvMystia,
    ...
    [SPECIES_ADVCIRNO] = gMonIcon_AdvCirno,
    [SPECIES_ADVREISEN] = gMonIcon_AdvReisen,
    ...
    [SPECIES_ADVMEILING] = gMonIcon_AdvMeiling,
    ...
    [SPECIES_ADVLETTY] = gMonIcon_AdvLetty,
    [SPECIES_ADVTEWI] = gMonIcon_AdvTewi,
    [SPECIES_ADVMARISA] = gMonIcon_AdvMarisa,
    [SPECIES_ADVALICE] = gMonIcon_AdvAlice,
    [SPECIES_TSANAE] = gMonIcon_TSanae,
    [SPECIES_YUKI] = gMonIcon_Yuki,
    [SPECIES_ADVMOKOU] = gMonIcon_AdvMokou,
    [SPECIES_ADVYUKARI] = gMonIcon_AdvYukari,
    [SPECIES_ADVRAN] = gMonIcon_AdvRan,
    [SPECIES_ADVCHEN] = gMonIcon_AdvChen,
