...
{
    SPECIES_AKYUU, SPECIES_SARIEL, SPECIES_AKOMACHI, SPECIES_SKOMACHI, SPECIES_AEIRIN,
    SPECIES_CMIKO, SPECIES_MIKO, SPECIES_CMAMIZOU, SPECIES_KASEN, SPECIES_GOMASEKI, 0xFFFF
};
