...
const u8 gTypeEffectiveness[285] =
{
    ...
    TYPE_FLYING, TYPE_NATURE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FLYING, TYPE_WIND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FLYING, TYPE_BLADE, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_MIASMA, TYPE_NATURE, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_MIASMA, TYPE_BLADE, TYPE_MUL_NO_EFFECT,
    TYPE_BLADE, TYPE_FIRE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BLADE, TYPE_WATER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BLADE, TYPE_BLADE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BLADE, TYPE_FLYING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BLADE, TYPE_DARK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BLADE, TYPE_ICE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DARK, TYPE_DREAM, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DARK, TYPE_GHOST, TYPE_MUL_NO_EFFECT,
    TYPE_DARK, TYPE_REASON, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_EARTH, TYPE_BLADE, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_FIRE, TYPE_BLADE, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_WIND, TYPE_NATURE, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_NATURE, TYPE_MIASMA, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NATURE, TYPE_EARTH, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_NATURE, TYPE_FLYING, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_REASON, TYPE_BLADE, TYPE_MUL_NOT_EFFECTIVE,
...
u8 IsRunningFromBattleImpossible(void)
{
    ...
    if (i != 0 && IS_BATTLER_OF_TYPE(gActiveBattler, TYPE_BLADE))
    {
                        ...
                        || gStatuses3[gActiveBattler] & STATUS3_ROOTED)
                    {
                        BtlController_EmitChoosePokemon(0, PARTY_ACTION_CANT_SWITCH, PARTY_SIZE, ABILITY_NONE, gBattleStruct->field_60[gActiveBattler]);
                             ...
                             || ((i = ABILITY_ON_OPPOSING_FIELD(gActiveBattler, ABILITY_ARENA_TRAP))
                                 ...
                                 && gBattleMons[gActiveBattler].ability != ABILITY_LEVITATE)
                             || ((i = AbilityBattleEffects(ABILITYEFFECT_CHECK_FIELD_EXCEPT_BATTLER, gActiveBattler, ABILITY_MAGNET_PULL, 0, 0))
                                 && IS_BATTLER_OF_TYPE(gActiveBattler, TYPE_BLADE)))
                    {
...
static void CheckFocusPunch_ClearVarsBeforeTurnStarts(void)
{
    ...
    gActionsByTurnOrder[(gCurrentTurnActionNumber = 0)];
    gDynamicBasePower = 0;
