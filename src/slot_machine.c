...
{
    {
        ...
        SLOT_MACHINE_TAG_CSHINGYOKU,
        SLOT_MACHINE_TAG_REPLAY,
        SLOT_MACHINE_TAG_POWER,
        SLOT_MACHINE_TAG_AHINA,
...
// tentative name
static const u8 gBiasTags[] = {
  SLOT_MACHINE_TAG_REPLAY, SLOT_MACHINE_TAG_CHERRY, SLOT_MACHINE_TAG_AHINA, SLOT_MACHINE_TAG_CSHINGYOKU, SLOT_MACHINE_TAG_POWER, SLOT_MACHINE_TAG_7_RED, SLOT_MACHINE_TAG_7_RED, SLOT_MACHINE_TAG_7_RED
};
