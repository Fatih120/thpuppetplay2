...
// Return values for DoGomasekiRockInteraction
#define GOMASEKI_ROCK_FAILED     0
#define GOMASEKI_ROCK_PROGRESSED 1
#define GOMASEKI_ROCK_SOLVED     2
#define GOMASEKI_ROCK_COMPLETE   3
