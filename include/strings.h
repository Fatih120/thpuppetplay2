...
extern const u8 gText_ExpandedPlaceholder_CMiko[];
extern const u8 gText_ExpandedPlaceholder_Miko[];
...
extern const u8 gText_DKanakoDoll32BP[];
extern const u8 gText_MargatroidDoll48BP[];
extern const u8 gText_CChenDoll48BP[];
extern const u8 gText_CYukariDoll48BP[];
extern const u8 gText_KedamaDoll48BP[];
extern const u8 gText_CEllyDoll80BP[];
extern const u8 gText_GenjiiDoll80BP[];
extern const u8 gText_OrangeDoll80BP[];

extern const u8 gText_TewiDoll128BP[];
extern const u8 gText_ByakurenDoll128BP[];
extern const u8 gText_CAliceDoll256BP[];
extern const u8 gText_ReisenDoll256BP[];
extern const u8 gText_CLilyBlackDoll256BP[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_DKanakoDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_MargatroidDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_CChenDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_CYukariDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_KedamaDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_CEllyDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_GenjiiDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_OrangeDollDesc[];
...
extern const u8 gTrickHouse_Mechadoll_CKeine[];
extern const u8 gTrickHouse_Mechadoll_DYuyuko[];
extern const u8 gTrickHouse_Mechadoll_TShou[];
extern const u8 gTrickHouse_Mechadoll_CShinGyoku[];
extern const u8 gTrickHouse_Mechadoll_AHina[];
extern const u8 gTrickHouse_Mechadoll_TKogasa[];
extern const u8 gTrickHouse_Mechadoll_TMedicine[];
extern const u8 gTrickHouse_Mechadoll_CMinoriko[];
extern const u8 gTrickHouse_Mechadoll_HShizuha[];
extern const u8 gTrickHouse_Mechadoll_Tenma[];
extern const u8 gTrickHouse_Mechadoll_HLunasa[];
extern const u8 gTrickHouse_Mechadoll_SSariel[];
extern const u8 gTrickHouse_Mechadoll_DYuyuko2[];
extern const u8 gTrickHouse_Mechadoll_DSuwako[];
extern const u8 gTrickHouse_Mechadoll_HLunasa2[];
extern const u8 gTrickHouse_Mechadoll_DYuyuko3[];
extern const u8 gTrickHouse_Mechadoll_CMinoriko2[];
extern const u8 gTrickHouse_Mechadoll_ATewi[];
...
extern const u8 gText_ListBySourceGame[];
...
extern const u8 gText_DexSearchSourceHRTP[];
extern const u8 gText_DexSearchSourceSOEW[];
extern const u8 gText_DexSearchSourcePODD[];
extern const u8 gText_DexSearchSourceLLS[];
extern const u8 gText_DexSearchSourceMS[];
extern const u8 gText_DexSearchSourceEOSD[];
extern const u8 gText_DexSearchSourcePCB[];
extern const u8 gText_DexSearchSourceIN[];
extern const u8 gText_DexSearchSourcePOFV[];
extern const u8 gText_DexSearchSourceMOF[];
extern const u8 gText_DexSearchSourceSA[];
extern const u8 gText_DexSearchSourceUFO[];
extern const u8 gText_DexSearchSourceTD[];
extern const u8 gText_DexSearchSourceDDC[];
extern const u8 gText_DexSearchSourceLOLK[];
extern const u8 gText_DexSearchSourceHSIFS[];
extern const u8 gText_DexSearchSourceWBAWC[];
extern const u8 gText_DexSearchSourceUM[];
extern const u8 gText_DexSearchSourceSPINOFF[];
extern const u8 gText_DexSearchSourcePRINT[];
extern const u8 gText_DexSearchSourceOTHER[];
...
extern const u8 gText_HEirinDollAndPrice[];
extern const u8 gText_AAliceDollAndPrice[];
extern const u8 gText_DReimuDollAndPrice[];
...
extern const u8 gText_DaiyouseiBerryPicking[];
